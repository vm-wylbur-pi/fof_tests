...
OneButton button1(pushButton1, true); //36
// Setup a new OneButton on pin A2.
OneButton button2(pushButton2, true); //next

OneButton button3(pushButton3, true);
...
// This function will be called when the button3 was pressed 1 time (and no 2. button press followed).
void click3() {
  ...
  display.println("www.makerfabs.com!");
  display.println("ESP32 Audio Player!");
  display.println("Pause or Resume!");
  display.display();
} // click3
// End
